<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Keluar</h5>
        ...
        <div class="modal-body">
            <form action="" method="post" id="form_penjualan">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pelanggan" class="form-control" placeholder="Masukan Nama Pemasok">
                </div>
                <div class="form-group">
                    <label>Tanggal</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="stok_keluar" placeholder="Masukan Stok Masuk" class="form-control">
                </div>
                <div class="form-group">
