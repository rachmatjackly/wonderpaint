...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-light sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" style="margin-bottom:100px" href="index.html">
            ...
            <li class="nav-item ">
                ...
                <div id="collapseTwo" class="collapse text-primary" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded ">
                        <a class="collapse-item text-primary" href="<?= base_url()?>persediaan/datamasuk">Data Masuk</a>
                        <a class="collapse-item text-primary" href="<?= base_url()?>persediaan/datakeluar">Data Keluar</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle d-flex flex-column-reverse gap-2" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mt-1 mb-2 d-none d-lg-inline text-gray-600 small"><?= $this->session->userdata('nama')?></span>
                                <i class="fas fa-user text-primary"></i>
                            </a>
