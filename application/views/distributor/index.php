            ...
            <div class="col-md-12">
                ...
                <div class="buttons d-flex justify-content-between">
                    ...
                    <div class="button d-flex justify-content-end">
                        <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#addDistributorModal"><i
                                class="fa fa-plus mr-1"></i>
                            Tambah
                        </button>
                        <a type="button" href="<?= base_url()?>distributor/edit" class="btn btn-warning text-white"><i class="fa fa-edit mr-1"></i>
                            Edit
                        </a>
                    </div>
                </div>
...
<div class="modal fade" id="addDistributorModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
